    ...
    <section className="pricing__section max-w-5xl px-7 lg:px-20 py-10 lg:py-20 mx-auto flex flex-col gap-y-10">
      ...
      <div className="flex flex-col lg:flex-row gap-10 items-center">
        {pricingData.map((item) => (
          <div key={item.title} className="p-0.5 rounded-2xl bg-gradient-to-tr from-cyan-400 via-teal-400 to-blue-400">
            <div

              className="pricing-section p-7 w-full flex flex-col items-center gap-y-5 justify-between border border-slate-500/20 rounded-2xl mx-auto bg-white"
            >
              ...
              <button
                ...
                className="w-full py-2 px-5 bg-cyan-500 hover:bg-teal-800 active:scale-95 transition-all duration-150 ease-linear active:ring-1 shadow-[3px_3px_0px_-0px_rgba(0,0,0,0.5)] shadow-teal-400 active:shadow-none active:ring-offset-2 active:ring-slate-600 rounded-md text-white "
              >
                Get started
              </button>
            </div>
